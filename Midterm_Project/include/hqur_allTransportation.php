<?php
include 'connect.php';
$hpsql = 'select * from tblData where CatId=4 order by DateIn desc';
...
?>
        <div class="container-place">
            ...
            <div class="block">
                ...
                <br>
                <div class="rate" style="display: flex; justify-content: space-between; width: 470px;">
